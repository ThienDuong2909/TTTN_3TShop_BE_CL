...
async function updateRoles() {
  try {
    ...
    console.log(`🚚 Cập nhật ${deliveryStaffCount[0]} tài khoản nhân viên giao hàng`);
    ...
    console.log(`🏪 Cập nhật ${storeStaffCount[0]} tài khoản nhân viên cửa hàng`);
    ...
    roleStats.forEach(stat => {
      console.log(`- ${stat.VaiTro.TenVaiTro}: ${stat.dataValues.count} tài khoản`);
    });
    
    console.log('\n✅ Cập nhật hệ thống phân quyền thành công!');
    console.log('📝 Xem file PHAN_QUYEN_SYSTEM.md để biết chi tiết về hệ thống phân quyền mới');
